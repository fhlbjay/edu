...
<div id="chart_toolbar">
    ...
    入学时间:<input id="beginTime" class="easyui-datebox" name="beginTime">~<input id="endTime" class="easyui-datebox" name="endTime">
    分类:<select id="groupByName" class="easyui-combobox" name="groupByName" style="width: 145px" data-options="panelHeight:'auto'">
    ...
    <a class="easyui-linkbutton" data-cmd="pie" data-options="plain:true,iconCls:'icon-edit'">饼状图</a>
    <a class="easyui-linkbutton" data-cmd="bar" data-options="plain:true,iconCls:'icon-edit'">柱状图</a>
</div>
</body>
</html>